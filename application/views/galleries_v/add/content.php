    ...
    <div class="col-md-12">
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("galeries/save"); ?>" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div id="control-demo-6" class="">
                            <select class="form-control gallery_type_select" name="gallery_type">
                    ...
                    <a href="<?php echo base_url("galeries"); ?>" class="btn btn-md btn-danger btn-outline">İptal</a>
                </form>
            </div><!-- .widget-body -->
        </div><!-- .widget -->
    </div><!-- END column -->
