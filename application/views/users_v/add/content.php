        ...
        <div class="widget">
            <div class="widget-body">
                <form action="<?php echo base_url("users/save"); ?>" method="post">
                    ...
                    <div class="form-group">
                        <label>Şifre</label>
                        <input class="form-control" type="password" placeholder="Şifre" name="password" value="<?php echo isset($form_error) ? set_value("password") : ""  ?>">
                        <?php if(isset($form_error)){ ?>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control" type="password" placeholder="Şifre" name="re_password" value="<?php echo isset($form_error) ? set_value("re_password") : ""  ?>">
                        <?php if(isset($form_error)){ ?>
