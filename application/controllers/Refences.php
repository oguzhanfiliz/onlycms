...
class References extends CI_Controller
{
	...
	public function save(){
		...
		// Kurallar yazilir..
		//HABER GÖRSEL ALANI VALİDATİON İŞLEMLERİ BURADA YAPILDI
		$references_type=$this->input->post("references_type");//references_type içeriğinde geleni aldık url ise ve name'i boş ise session olayını tekrarladık.
...
//HABER BAŞLIK ALANI VALİDATİON İŞLEMLERİ BURADA YAPILDI
...
//upload süreci
	...
	public function update($id){
		...
		if($validate){
			...
			$this->session->set_flashdata("alert", $alert);
			redirect(base_url("references_v"));
